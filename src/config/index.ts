...
const envSchema = Joi.object({
  ...
  PUBSUB_TOPIC_NAME: Joi.string().allow("").optional(), // Nombre del tema de Pub/Sub para eventos de juego
  PUBSUB_SUBSCRIPTION_NAME: Joi.string().allow("").required(), // Nombre de la suscripción de Pub/Sub para procesar eventos
...
export const config = {
  ...
  mlbStatsBaseUrl: value.MLB_STATS_BASEURL,
  ...
  pubsubSubscriptionName:
    ...
    "projects/tu-proyecto/subscriptions/tu-suscripcion",
  enablePubsubProcessor: value.ENABLE_PUBSUB_PROCESSOR,
  // Puedes añadir configuraciones adicionales para el logger si es necesario
  // e.g., logLevel: value.LOG_LEVEL || "info",
